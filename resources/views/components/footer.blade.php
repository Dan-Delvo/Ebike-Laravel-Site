        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                <div>
                    ...
                    <p class="text-gray-400">Powering the future of sustainable transportation, one charge at a
                        time.</p>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="#how-it-works" class="hover:text-green-400 transition-colors">How It
                                Works</a></li>
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <a href="https://github.com/Dan-Delvo"
                            class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-green-500 transition-colors">
                        ...
                        <a href="https://www.linkedin.com/in/dan-jaspher-delvo"
                            class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-green-500 transition-colors">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
